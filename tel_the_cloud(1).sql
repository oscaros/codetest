...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2019 at 09:16 PM
...
CREATE TABLE `tbl_users` (
  ...
  `phone_mac_addr` varchar(50) NOT NULL,
...
INSERT INTO `tbl_users` (`userId`, `email`, `password`, `name`, `mobile`, `phone_mac_addr`, `roleId`, `isDeleted`, `createdBy`, `createdDtm`, `updatedBy`, `updatedDtm`) VALUES
(1, 'admin@eco2016.org', '$2y$10$IUgslf6w8YBoxkHVDMzrMe8gOdomUJxbgOiczytzeEpo/cc0Ltbt.', 'Komuntu Oscar', '9890098900', '', 1, 0, 0, '2015-07-01 18:56:49', 1, '2018-07-24 11:16:46'),
